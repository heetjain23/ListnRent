...
import { DISPUTE_CATEGORY } from "@listnrent/shared/constants";
...
const DisputeCreateModal = ({ isOpen, booking, onClose, onSuccess }) => {
  ...
  const validate = () => {
    ...
    if (!bookingSummary?.bookingId) nextErrors.booking = "Booking details are missing.";
